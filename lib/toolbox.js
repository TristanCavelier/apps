...
(function (exports) {
  ...
  exports.stringToUint8Array = stringToUtf8Uint8Array;
  exports.stringToUtf8ArrayBuffer = function (sDOMStr) {
    return stringToUtf8Uint8Array(sDOMStr).buffer;
  };
  exports.stringToArrayBuffer = exports.stringToUtf8ArrayBuffer;

  function stringToUtf8BinaryString(sDOMStr) {
    /*jslint plusplus: true, bitwise: true */
    // Assuming javascript string is Utf-16
    ...
    for (nChrIdx = 0; nChrIdx < nStrLen; nChrIdx += 1) {
      ...
      if (nChr < 128) {
        ...
        /* two bytes */
        bsBytes += String.fromCharCode(192 + (nChr >>> 6));
        bsBytes += String.fromCharCode(128 + (nChr & 63));
      } else if (nChr < 0x10000) {
        /* three bytes */
        bsBytes += String.fromCharCode(224 + (nChr >>> 12));
        bsBytes += String.fromCharCode(128 + (nChr >>> 6 & 63));
        bsBytes += String.fromCharCode(128 + (nChr & 63));
      } else if (nChr < 0x200000) {
        /* four bytes */
        bsBytes += String.fromCharCode(240 + (nChr >>> 18));
        bsBytes += String.fromCharCode(128 + (nChr >>> 12 & 63));
        bsBytes += String.fromCharCode(128 + (nChr >>> 6 & 63));
        bsBytes += String.fromCharCode(128 + (nChr & 63));
      } else if (nChr < 0x4000000) {
        /* five bytes */
        bsBytes += String.fromCharCode(248 + (nChr >>> 24));
        bsBytes += String.fromCharCode(128 + (nChr >>> 18 & 63));
        bsBytes += String.fromCharCode(128 + (nChr >>> 12 & 63));
        bsBytes += String.fromCharCode(128 + (nChr >>> 6 & 63));
        bsBytes += String.fromCharCode(128 + (nChr & 63));
      } else { /* if (nChr <= 0x7fffffff) */
        /* six bytes */
        bsBytes += String.fromCharCode(252 + /* (nChr >>> 32) is not possible in ECMAScript! So...: */ (nChr / 1073741824));
        bsBytes += String.fromCharCode(128 + (nChr >>> 24 & 63));
        bsBytes += String.fromCharCode(128 + (nChr >>> 18 & 63));
        bsBytes += String.fromCharCode(128 + (nChr >>> 12 & 63));
        bsBytes += String.fromCharCode(128 + (nChr >>> 6 & 63));
        bsBytes += String.fromCharCode(128 + (nChr & 63));
  ...
  exports.stringToUtf8BinaryString = stringToUtf8BinaryString;
  exports.stringToBinaryString = stringToUtf8BinaryString;
