...
(function (exports) {
  ...
  /*global Blob, FileReader, ArrayBuffer, Uint8Array, Uint16Array, URL, XMLHttpRequest,
           setTimeout, clearTimeout, btoa, atob, document, open, localStorage */

  //////////////////////////////////////////////////

  var textToUint8Array, textToArrayBuffer, textToBinaryString,
    ...
    urlPortStringRegExp, urlEscapedCharStringRegExp,
    urlPathNameCharsetStringRegExp, urlQueryCharsetStringRegExp, urlHashCharsetStringRegExp,
    urlPathNameStringRegExp, urlQueryStringRegExp, urlHashStringRegExp,
  ...
  urlPathNameStringRegExp = "(?:(?:" + urlEscapedCharStringRegExp + "|" + urlPathNameCharsetStringRegExp + ")+)";
  urlQueryCharsetStringRegExp = "[a-zA-Z0-9\\-_\\.!~\\*'\\(\\);,/\\?:@&=\\+\\$]";
  urlQueryStringRegExp = "(?:(?:" + urlEscapedCharStringRegExp + "|" + urlQueryCharsetStringRegExp + ")+)";
  urlHashCharsetStringRegExp = "[a-zA-Z0-9\\-_\\.!~\\*'\\(\\);,/\\?:@&=\\+\\$#]";
  urlHashStringRegExp = "(?:(?:" + urlEscapedCharStringRegExp + "|" + urlHashCharsetStringRegExp + ")+)";
  ...
  exports.detectEndianness = detectEndianness;
  ...
  exports.utf16ArrayBufferToText = utf16ArrayBufferToText;

  function utf16Uint16ArrayToText(uint16Array) {
    return String.fromCharCode.apply(null, uint16Array);
  }
  exports.utf16Uint16ArrayToText = utf16Uint16ArrayToText;
  ...
  exports.textToUtf16Uint16Array = textToUtf16Uint16Array;

  function textToUtf16ArrayBuffer(text) {
    return textToUtf16Uint16Array(text).buffer;
  }
  exports.textToUtf16ArrayBuffer = textToUtf16ArrayBuffer;
  ...
  exports.textToUtf16BigEndianUint8Array = textToUtf16BigEndianUint8Array;

  function textToUtf16BigEndianArrayBuffer(text) {
    return textToUtf16BigEndianUint8Array(text).buffer;
  }
  exports.textToUtf16BigEndianArrayBuffer = textToUtf16BigEndianArrayBuffer;
  ...
  exports.textToUtf16LittleEndianUint8Array = textToUtf16LittleEndianUint8Array;

  function textToUtf16LittleEndianArrayBuffer(text) {
    return textToUtf16LittleEndianUint8Array(text).buffer;
  }
  exports.textToUtf16LittleEndianArrayBuffer = textToUtf16LittleEndianArrayBuffer;
  ...
  exports.textToUtf16BigEndianBinaryString = textToUtf16BigEndianBinaryString;
  ...
  exports.textToUtf16LittleEndianBinaryString = textToUtf16LittleEndianBinaryString;
  ...
  exports.textToUtf8Uint8Array = textToUtf8Uint8Array;
  ...
  exports.textToUtf8ArrayBuffer = textToUtf8ArrayBuffer;
  ...
  exports.textToUtf8BinaryString = textToUtf8BinaryString;
  textToBinaryString = textToUtf8BinaryString;
  exports.textToBinaryString = textToBinaryString;
  ...
  exports.utf8Uint8ArrayToText = utf8Uint8ArrayToText;
  uint8ArrayToText = utf8Uint8ArrayToText;
  exports.uint8ArrayToText = uint8ArrayToText;

  function utf8ArrayBufferToText(arrayBuffer) {
    return utf8Uint8ArrayToText(new Uint8Array(arrayBuffer));
  }
  exports.utf8ArrayBufferToText = utf8ArrayBufferToText;
  ...
  exports.utf8BinaryStringToText = utf8BinaryStringToText;
  binaryStringToText = utf8BinaryStringToText;
  exports.binaryStringToText = binaryStringToText;
  ...
  urlParserRegExp = new RegExp("^" +
    "(?:" +
      ...
      ")?" +
      "(/" + urlPathNameStringRegExp + ")?" + // 6 absolute url pathname
      "(\\?" + urlQueryStringRegExp + ")?" + // 7 absolute url query search
      "(#" + urlHashStringRegExp + ")?" + // 8 absolute url hash
    "|" +
      "(" + urlPathNameStringRegExp + ")?" + // 9 relative url pathname
      "(\\?" + urlQueryStringRegExp + ")?" + // 10 relative url query search
      "(#" + urlHashStringRegExp + ")?" + // 11 relative url hash
    ")$");
  ...
  function parseURL(url) {
    ...
    if (parsed[7] !== undefined) { result.search = parsed[7]; }
    if (parsed[8] !== undefined) { result.hash = parsed[8]; }
    if (parsed[9] !== undefined) { result.pathname = parsed[9]; }
    if (parsed[10] !== undefined) { result.search = parsed[10]; }
    if (parsed[11] !== undefined) { result.hash = parsed[11]; }
  ...
  function resolveURL(fromURL, toURL) {
    ...
    if (toURL.pathname) {
      ...
      toURL.pathname = resolvePath((fromURL.pathname || "").replace(/[^\/]+$/g, ""), toURL.pathname);
      return makeURL(toURL);
    }
  ...
  function parseContentTypeToObject(contentType) {
  ...
  exports.parseContentTypeToObject = parseContentTypeToObject;
  ...
  function parseDataURIAsBlob(dataURI) {
    ...
    mimetype = parseContentTypeToObject(mimetype);
    ...
    return function (uri) {
      ...
      return this.then(function (input) {
        ...
        if (typeof obj.uri === "string") {
          obj.uri = obj.uri.replace(/^(?:web)?dav(s?):(?:http(s)?:)?/, function (match, s, s2) {
            /*jslint unparam: true */
            return "http" + (s2 || s) + ":";
          });
        }
  ...
  ExtendedCancellableChain.prototype.iframe = function () {
    return this.toDataURI("text/html").then(function (input) {
