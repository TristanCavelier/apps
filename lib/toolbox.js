...
(function (exports) {
  ...
  ExtendedCancellableChain.prototype.alert = function (message) {
    return this.then(function (input) {
      ...
      beam.style.maxHeight = window.innerHeight + "px";
      ...
      windoww.style.borderColor = "black";
      windoww.style.borderWidth = "1px";
      ...
      layout.style.height = document.body.scrollHeight + "px";
